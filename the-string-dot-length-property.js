...
// Your code here
console.log("The length of \"" + stringOne + "\" is " + lengthOne + " characters.");
console.log("The length of \"" + stringTwo + "\" is " + lengthTwo + " characters.");
console.log("The length of \"" + stringThree + "\" is " + lengthThree + " characters.");
